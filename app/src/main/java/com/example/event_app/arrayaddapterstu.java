...
public class arrayaddapterstu extends ArrayAdapter<PartiInfo>
{
    private Activity context;
    private List<PartiInfo> partiList;

    public  arrayaddapterstu(Activity context, List<PartiInfo> partiList)
    {
    ...
    public View getView(int position, View convertView, ViewGroup parent)
    {
        ...
        textViewname.setText((art.getName()));
        return listviewitem;
